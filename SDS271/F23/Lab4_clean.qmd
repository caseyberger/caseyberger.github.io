# Lab 4: Data Science Libraries in Python
...
::: {.alert .alert-info}
Exercise 19: In the code cell below, plot the experimental binding energies per nucleon, the theoretical binding energies per nucleon, and the binding energies per nucleon from the liquid drop model.
...
![](./graphics/hcf-joe-sunglasses.gif)
